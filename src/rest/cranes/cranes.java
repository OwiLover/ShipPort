...
public class cranes {
    ...
    static void readsched(List<ships> ship) throws IOException {
...
//         }
            ...
            System.out.println(" ");
            report.add(""+(craneStationContainer.unloadShipCount+craneStationFluid.unloadShipCount+craneStationDry.unloadShipCount));
            System.out.println("Total ships unloaded: " + report.get(0));
            report.add(""+averageWait);
            System.out.println("Average queue size: " + report.get(1));
            report.add(""+ waitDate + " "+ waitHour+" "+waitMinute);
            System.out.println("Average queue wait time: " + report.get(2));
            ...
            report.add(""+ waitUnloadDate + " "+ waitUnloadHour+" "+ waitUnloadMinute);
            System.out.println("Average unload delay: "+report.get(3));
            if (craneStationDry.longestUnloadDelay != 0) {
                ...
                report.add(""+waitUnloadDate + " " + waitUnloadHour + " " + waitUnloadMinute);
                System.out.println("Longest unload delay from Dry: " + report.get(4));
            ...
            if (craneStationFluid.longestUnloadDelay !=0 ) {
                ...
                report.add(""+waitUnloadDate + " " + waitUnloadHour + " " + waitUnloadMinute);
                System.out.println("Longest unload delay from Fluid: " + report.get(5));
            } else report.add("None");
            ...
            if (craneStationContainer.longestUnloadDelay !=0) {
                ...
                report.add(""+waitUnloadDate + " " + waitUnloadHour + " " + waitUnloadMinute);
                System.out.println("Longest unload delay from Container: " + report.get(6));
            } else report.add("None");
            System.out.println(" ");
            report.add(""+totalBill);
            System.out.println("Total Bill: " + report.get(7));
            System.out.println(" ");
            report.add(""+craneStationFluid.getCraneCount());
            report.add(""+craneStationDry.getCraneCount());
            report.add(""+craneStationContainer.getCraneCount());
            System.out.println("Cranes count:");
            System.out.println("Fluid cranes - " + report.get(8));
            System.out.println("Dry cranes - " + report.get(9));
            System.out.println("Container cranes - " + report.get(10));
//            System.out.println(report);
            String url = "http://localhost:8081/results/"+report.get(0);
            for (int i = 1; i<report.size(); i++) {
                url += ","+report.get(i);
            }

            RestTemplate restTemplate = new RestTemplate();
            ResponseEntity<String> responseEntity = restTemplate.postForEntity(url, 2, String.class);
